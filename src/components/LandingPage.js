        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="max-w-md mx-auto mt-8 text-center">
            <p className="text-sm text-gray-400 mb-2">
              ...
              <a
                href="https://torbox.app/subscription?referral=4d1099fc-c44c-4cd0-bfdc-52cd60ca35ec"
                target="_blank"
                rel="noopener noreferrer"
                className="text-blue-400 hover:text-blue-300 underline"
              >
              ...
              <button
                onClick={async () => {
                  await navigator.clipboard.writeText('4d1099fc-c44c-4cd0-bfdc-52cd60ca35ec');
                  setShowCopied(true);
          ...
          <footer className="mt-12 text-sm text-gray-400">
            <p>
              ...
              <a
                href="https://github.com/aves-omni/torbox-app"
                target="_blank"
                rel="noopener noreferrer"
                className="text-blue-400 hover:text-blue-300 underline"
              >
